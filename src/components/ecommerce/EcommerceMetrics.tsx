import { BrainIcon, ClockIcon, FileIcon, GroupIcon } from "../../icons";
    ...
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-4 md:gap-6">
      <div className="rounded-2xl border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center justify-center w-16 h-16 bg-gray-100 rounded-4xl dark:bg-gray-800">
            <FileIcon className="text-green size-8 dark:text-green/90" />
          </div>
        </div>
        <div className="pt-6">
      ...
      <div className="rounded-2xl border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center justify-center w-16 h-16 bg-gray-100 rounded-4xl dark:bg-gray-800">
            <ClockIcon className="text-primary size-8 text-red dark:text-red/90" />
          </div>
        </div>
        <div className="pt-6">
          <p className="text-md text-black-700 dark:text-white-700">
      ...
      <div className="rounded-2xl border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center justify-center w-16 h-16 bg-gray-100 rounded-4xl dark:bg-gray-800">
            <BrainIcon className="text-primary size-8 dark:text-primary/90" />
          </div>
        </div>
        <div className="pt-6">
          <p className="text-md text-black-700 dark:text-white-700">
