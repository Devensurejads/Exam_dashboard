import { ClockIcon, GraphIcon, SparkIcon } from "../../icons";

export default function EcommerceStudentMetrics() {
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-4 md:gap-6">
            <div className="rounded-2xl border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center justify-center w-16 h-16 bg-gray-100 rounded-4xl dark:bg-gray-800">
                        <GraphIcon className="text-green size-8 dark:text-primary/90" />
                    </div>
                </div>
            </div>
            ...
            <div className="rounded-2xl border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center justify-center w-16 h-16 bg-gray-100 rounded-4xl dark:bg-gray-800">
                        <SparkIcon className="text-purple size-8 dark:text-purple/90" />
                    </div>
                </div>
            </div>
            ...
            <div className="rounded-2xl border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center justify-center w-16 h-16 bg-gray-100 rounded-4xl dark:bg-gray-800">
                        <ClockIcon className="text-primary size-8 dark:text-green/90" />
                    </div>
                </div>
            </div>
