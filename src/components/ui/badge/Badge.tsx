...
const Badge: React.FC<BadgeProps> = ({
  ...
  const variants = {
    light: {
      primary: "bg-brand-50 text-primary dark:bg-brand-500/15 dark:text-brand-400",
      ...
      "dark-orange": "bg-orange-100 text-orange-700 dark:bg-orange-500/15 dark:text-orange-400",
    ...
    solid: {
      ...
      "dark-orange": "bg-orange-500 text-white dark:text-white",
